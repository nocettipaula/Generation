...
programa
{
	...
	funcao inicio()
	{
		...
		{
			escreva (" Se o indice for maior que ", indice, " Empresas de 1° grupo, suspendem atividade ")
			
		}
		se(indice >= 0.5)
			{
			escreva (" Se o indice atigir ", indice, " todos os grupos devem paralizar suas atividades ")
			}

		se (indice >= 0.4 e indice < 0.5) 
			{
			escreva (" Se o indice crescer ", indice, " as industrias de 1° e 2° grupo suspendem as atividades ")
